# Generated by Django 5.1.2 on 2024-11-27 06:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('category', models.CharField(max_length=255)),
                ('DatePicker', models.DateField(blank=True, null=True)),
                ('logistics_id', models.CharField(editable=False, max_length=20, primary_key=True, serialize=False)),
                ('logistics_types', models.CharField(choices=[('Staff', 'Staff'), ('Cargo', 'Cargo')], default='staff_logistics', max_length=255)),
